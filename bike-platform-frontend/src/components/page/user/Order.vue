    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                <el-button type="primary" icon="el-icon-search" @click="showAddForm">添加</el-button>
            </div>
            <el-table
                    :data="tableData"
                    border
            ...
            >
                <el-table-column prop="title" label="自行车信息"></el-table-column>
                <el-table-column prop="rentUser" label="出借人"></el-table-column>
                <el-table-column prop="orderUser" label="借用人"></el-table-column>
                <el-table-column prop="startAt" label="开始日期"></el-table-column>
                <el-table-column prop="endAt" label="结束日期"></el-table-column>
                <el-table-column prop="type" label="类型"></el-table-column>
                <el-table-column prop="status" label="状态"></el-table-column>
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <el-button type="text" size="small" v-if="scope.row.status !== '已完成'" @click="onCompleteOrder">完成订单</el-button>
                        <el-button type="text" size="small" @click="showAddForm">发送消息</el-button>
<!--                        <el-button type="text" size="small" @click="showEditForm" v-else>编辑</el-button>-->
<!--                        <el-button type="text" size="small" @click="delJob" v-if="scope.row.userId === user.id">删除</el-button>-->
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getRecruitments() {
                post(`/order/list`, this.query).then(res => {
                    this.tableData = res.data.data.filter(item => {
                        if (item.orderUserId === this.user.id) {
                            return item
                        }
                    })
